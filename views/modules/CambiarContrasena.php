...
<div class="form-group">
	...
	<div class="form-group">
		...
		<input class="form-control" type="password"  maxlength="20" name="contrasenaNueva" value="" required>
	</div>
	<div class="form-group">
		<label>Confirmar contraseña nueva:</label>
		<input class="form-control" type="password"  maxlength="20" name="verificarContrasena" value="" required>
	</div>
